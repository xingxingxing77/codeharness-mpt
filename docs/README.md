...
- 门禁基线：**十一个不花钱脚本全 exit 0** —— s1(12)/s2(14)/s3a(13)/s3b(13)/s4(35)/s5(25)/**s6(22)**/s8(6) + test_p1/test_roles_registry/test_e2e_classic_line。t11 比对法升级为 AST 值比对（文件子串法对 `\` 续行常量假阳性）。
